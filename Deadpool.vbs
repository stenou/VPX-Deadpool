...
Dim aBall, bBall, cBall
LilDPInit

Sub LilDPInit
    Set aBall = he.createball
    Set bBall = la.createball
    Set cBall = ra.createball
    he.Kick 0, 0
    la.Kick 0, 0
    ra.Kick 0, 0
    lilShakeTimer.Enabled = 1
End Sub

Sub LilDPShake(strength) 'strength could be from 1 to 5
    aball.velx = - strength * RND(1)
    aball.vely = - strength * RND(1)
    bball.velx = - strength * RND(1)
    bball.vely = - strength * RND(1)
    cball.velx = - strength * RND(1)
    cball.vely = - strength * RND(1)
End Sub
...
Sub RandomTitleTrack
    dim b
    b = RndNbr(5)
    Select Case b
        Case 1:PlaySong "mu_gameover"
        case 2:PlaySong "mu_SexyMF"
        case 3:PlaySong "mu_XforceSM"
        case 4:PlaySong "mu_boom-dp-rap"
        case 5:PlaySong "mu_multiball"
    End Select
End Sub
...
Sub AwardJackpot() 'award a normal jackpot
    If bLilDPMB Then
        Select case RndNbr(4)
            Case 1:DMD CL(0, FormatScore(Jackpot(CurrentPlayer) ) ), CL(1, "LILDP JACKPOT"), "bkborder", eBlinkFast, eBlinkFast, eNone, 1000, True, "vo_lildp_jackpot1"
            Case 2:DMD CL(0, FormatScore(Jackpot(CurrentPlayer) ) ), CL(1, "LILDP JACKPOT"), "bkborder", eBlinkFast, eBlinkFast, eNone, 1000, True, "vo_lildp_jackpot2"
            Case 3:DMD CL(0, FormatScore(Jackpot(CurrentPlayer) ) ), CL(1, "LILDP JACKPOT"), "bkborder", eBlinkFast, eBlinkFast, eNone, 1000, True, "vo_lildp_jackpot3"
            Case 4:DMD CL(0, FormatScore(Jackpot(CurrentPlayer) ) ), CL(1, "LILDP JACKPOT"), "bkborder", eBlinkFast, eBlinkFast, eNone, 1000, True, "vo_lildp_jackpot4"
        End Select
        LightEffect 4
        GiEffect 4
    Else
...
Sub AwardMegaJackpot() 'award a Megalodon Jackpot
    DMD CL(0, FormatScore(Jackpot(CurrentPlayer) ) ), CL(1, "MEGALODON JACKPOT"), "d_megalodon", eBlinkFast, eBlinkFast, eNone, 1000, True, "vo_Jackpot"
    DOF 126, DOFPulse
...
Sub AwardSuperMegaJackpot() 'award a SuperMegalodon Jackpot
    ...
    DMD CL(0, FormatScore(MegaSuperJValue) ), "MEGALODON SUPJACKPOT", "d_megalodon", eBlinkFast, eBlinkFast, eNone, 1000, True, "vo_superjackpot"
    DOF 126, DOFPulse
...
Sub CheckDead
    ...
    If tmp = 4 then 'enable Battle at the scoop
        DMD "   BATTLE IS READY  ", "  AT THE HELLHOUSE  ", "", eNone, eNone, eNone, 1000, True, "vo_battleislit"
...
Sub CheckDisco
    Select Case LeftSpinnerCount(CurrentPlayer)
        Case 50 'Disco Loops
            DMD "_", CL(1, "DISCO LOOPS"), "", eNone, eNone, eNone, 1500, True, "vo_discoloops"
            StartDisco
            StartSpots
            OpenGates
            ...
            li053.State = 2
        Case 100                                'Disco MB
            DMD "_", CL(1, "DISCO MULTIBALL"), "", eNone, eNone, eNone, 1500, True, "vo_discoloops"
...
Sub UpdateDMDBattle
    ...
    Select Case Battlenr
        Case 1:DMDFlush:DMD "      JUGGERNAUT", tmp, "d_juggernaut", eNone, eNone, eNone, 10000, True, "vo_juggernaut"
        case 2:DMDFlush:DMD "       MYSTIQUE", tmp, "d_mystique", eNone, eNone, eNone, 10000, True, "vo_mystique"
        Case 3:DMDFlush:DMD "      SABRETOOTH", tmp, "d_sabretooth", eNone, eNone, eNone, 10000, True, "vo_sabretooth"
        Case 4:DMDFlush:DMD "        T-REX", tmp, "d_trex", eNone, eNone, eNone, 10000, True, "vo_trex"
        Case 5:DMDFlush:DMD "       MEGALODON", tmp, "d_megalodon", eNone, eNone, eNone, 10000, True, "vo_megalodon"
        Case 6:DMDFlush:DMD "         SAURON", tmp, "d_sauron", eNone, eNone, eNone, 10000, True, "vo_sauron"
        Case 7:DMDFlush:DMD "     MR-SINISTER", tmp, "d_mrsinister", eNone, eNone, eNone, 10000, True, "vo_mrsinister"
    End Select
End Sub
...
Sub StartBattle(n)
    ...
    Select Case Battle(CurrentPlayer, 0)
        Case 1 'Juggernaut
            DMD "  SHOOT DP TARGETS", "TO ATTACK JUGGERNAUT", "d_juggernaut", eNone, eNone, eNone, 3000, True, "vo_shootflashingshots"
            If LifeLeft(CurrentPlayer, 1)> 6 Then
        ...
        Case 2 'Mystique
            DMD " SHOOT WHITE SHOTS", "  TO ATTACK MYSTIQUE", "d_mystique", eNone, eNone, eNone, 3000, True, "vo_shoot-mystique"
            BattleLights(4) = 2
        ...
        Case 3 'Sabretooth
            DMD " SHOOT POP BUMPERS", "TO ATTACK SABRETOOTH", "d_sabretooth", eNone, eNone, eNone, 3000, True, "vo_shoot-sabretooth"
            ...
            ChangeGiIntensity 1.3
        Case 4 'T-Rex
            DMD " SHOOT GREEN SHOTS", " TO ATTACK T-REX", "d_trex", eNone, eNone, eNone, 3000, True, "vo_shootgreenshots-trex"
            ...
            ChangeGiIntensity 2
        Case 5 'Megalodon
            DMD "   SHOOT RED SHOTS", " TO ATTACK MEGALODON", "d_megalodon", eNone, eNone, eNone, 3000, True, "vo_shootflashingshots"
            For each x in aArrows
            ...
            ChangeGiIntensity 2
        Case 6 'Sauron
            DMD " SHOOT GREEN SHOTS", " TO ATTACK SAURON", "d_sauron", eNone, eNone, eNone, 3000, True, "vo_shootgreenshots-sauron"
            AddMultiball 2
            BattleLights(2) = 2
            BattleLights(5) = 2
            OpenGates
            ...
            ChangeGiIntensity 2
        Case 7 'MrSinister
            DMD "SHOOT FLASHING SHOTS", "TO ATTACK MRSINISTER", "d_mrsinister", eNone, eNone, eNone, 3000, True, "vo_shootflashingshots-ifyoudare"
            Select case RndNbr(4)
                Case 1:BattleLights(1) = 2
...
Sub WinBattle
    ...
    Select Case Battle(CurrentPlayer, 0)
        Case 1 'Juggernaut
            ...
            Flasher003.visible = 0
            DMD "         JUGGERNAUT", "          DEFEATED", "d_juggernaut", eBlink, eNone, eNone, 2000, False, "vo_juggernautdefeated"
        Case 2 'Mystique
            Battle(CurrentPlayer, 2) = 1
            Flasher004.visible = 0
            DMD "          MYSTIQUE", "          DEFEATED", "d_mystique", eBlink, eNone, eNone, 2000, False, "vo_mystiquedefeated"
        Case 3 'Sabretooth
            Battle(CurrentPlayer, 3) = 1
            li001.State = 0
            Flasher005.visible = 0
            DMD "         SABRETOOTH", "          DEFEATED", "d_sabretooth", eBlink, eNone, eNone, 2000, False, "vo_sabretoothdefeated"
        Case 4 'T-Rex
            Battle(CurrentPlayer, 4) = 1
            DMD "           T-REX", "          DEFEATED", "d_trex", eBlink, eNone, eNone, 2000, False, "vo_trexdefeated"
            Flasher002.visible = 0
        Case 5 'Megalodon
            Battle(CurrentPlayer, 5) = 1
            Flasher006.visible = 0
            DMD "          MEGALODON", "          DEFEATED", "d_megalodon", eBlink, eNone, eNone, 2000, False, "vo_megalodondefeated"
        Case 6 'Sauron
            Battle(CurrentPlayer, 6) = 1
            DMD "           SAURON", "          DEFEATED", "d_sauron", eBlink, eNone, eNone, 2000, False, "vo_saurondefeated"
        Case 7 'MrSinister
            Jackpot(CurrentPlayer) = 1000000 * BattlesWon(CurrentPlayer)
            Battle(CurrentPlayer, 7) = 1
            DMD "         MRSINISTER", "          DEFEATED", "d_mrsinister", eBlink, eNone, eNone, 2000, False, "vo_mrsinisterdefeated"
            MrSinisterTimer.Enabled = 0
            ResetForNewRound
...
Sub CheckCombo(n)
    ...
    If n = "Trigger013" AND LastSwitchHit = "Trigger010" Then 'NinjaApocalypse
        DMD CL(0, "NINJA"), CL(1, "APOCAYPSE"), "d_ninjamb", eNone, eNone, eNone, 1500, True, "vo_supercombo"
        For x = 1 to 10
            CheckNinjaStars
        Next
...
Sub CheckDazzler
    If DazzlePower(CurrentPlayer) = 4 Then
        DMD "  DAZZLER", "  TEAM-UP", "d_dazzler", eNone, eNone, eNone, 1500, True, "vo_dazzlerteamup"
...
Sub CheckColossus
    If ColossusPower(CurrentPlayer) = 4 Then
        DMD " COLOSSUS", "  TEAM-UP", "d_colossus", eNone, eNone, eNone, 1500, True, "vo_colossusteamup"
...
Sub CheckWolverine
    If WolverinePower(CurrentPlayer) = 4 Then
        DMD " WOLVERINE", "  TEAM-UP", "d_wolverine", eNone, eNone, eNone, 1500, True, "vo_wolverineteamup"
...
Sub CheckDomino
    If DominoPower(CurrentPlayer) = 4 Then
        DMD " DOMINO", "  TEAM-UP", "d_domino", eNone, eNone, eNone, 1500, True, "vo_dominoteamup"
...
Sub StartMechSuitMB
    Dim i
    DMD CL(0, "MECH SUIT"), CL(1, "MULTIBALL"), "", eNone, eNone, eNone, 1500, True, "vo_multiball"
    ...
    ElseIf bLockEnabled Then
        ...
        Select Case BallsInLock(CurrentPLayer)
            ...
            Case 3:DMD "", "", "d_lock3", eNone, eNone, eNone, 1500, True, "vo_ball3locked"
                ...
                DMD CL(0, "NINJA"), CL(1, "MULTIBALL"), "", eNone, eNone, eNone, 1500, True, "vo_multiball"
...
Sub CollectChimichanga
    DMD CL(0, "COLLECTED ONE"), CL(1, "CHIMICHANGA"), "d_chimi2", eNone, eNone, eNone, 1000, True, "sfx17"
...
Sub CheckKatanarama 'increases the counter and check the lights to start KatanaramaTime
    ...
    Select Case KatanaramaCount(CurrentPlayer)
        Case 1
            ...
            DiamondLights(CurrentPlayer, 2) = 2
            DMD "1 DIAMOND COLLECTED", "", "d_diamond1", eNone, eNone, eNone, 1000, True, "fanfare"
        Case 2
            DiamondLights(CurrentPlayer, 2) = 1
            DiamondLights(CurrentPlayer, 3) = 2
            DMD "2 DIAMONDS COLLECTED", "", "d_diamond2", eNone, eNone, eNone, 1000, True, "fanfare"
        Case 3
            DiamondLights(CurrentPlayer, 3) = 1
            DiamondLights(CurrentPlayer, 4) = 2
            DMD "3 DIAMONDS COLLECTED", "", "d_diamond3", eNone, eNone, eNone, 1000, True, "fanfare"
        Case 4
            DiamondLights(CurrentPlayer, 4) = 1
            DiamondLights(CurrentPlayer, 5) = 2
            DMD "4 DIAMONDS COLLECTED", "", "d_diamond4", eNone, eNone, eNone, 1000, True, "fanfare"
        Case 5
            DiamondLights(CurrentPlayer, 5) = 1
            DiamondLights(CurrentPlayer, 6) = 2
            DMD "5 DIAMONDS COLLECTED", "", "d_diamond5", eNone, eNone, eNone, 1000, True, "fanfare"
        Case 6 'all diamonds are on, so start katanarama time
            DiamondLights(CurrentPlayer, 6) = 1
            DMD "6 DIAMONDS COLLECTED", "", "d_diamond6", eNone, eNone, eNone, 1000, True, "vo_katanaramaisready"
            DMD CL(0, "STARTING"), CL(1, "KATANARAMA TIME"), "", eNone, eNone, eNone, 1500, True, ""
            DMD CL(0, "KATANARAMA TIME"), CL(1, "SHOOT ORBITS-RAMPS"), "", eNone, eNone, eNone, 1500, True, ""
            StartKatanarama
    End Select
End Sub
